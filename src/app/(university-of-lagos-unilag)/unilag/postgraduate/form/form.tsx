    ...
    return (
        <div>
            ...
            <div className="p-4">
                ...
                <h2 className="text-2xl font-bold mt-8 mb-4" id="admission-form">How to Apply for the UNILAG Postgraduate Form</h2>
                <p className="text-lg leading-7 mb-4">The 2024/2025 Admission Form of UNILAG PG School can be purchased from any of the banks within the campus or via the online platform (Remita).</p>
                ...
                <li className="text-lg leading-7 mb-4 flex items-start gap-2"> <FaCheckCircle className="mt-1 min-h-5 min-w-5 text-vasaskills-green" />Middle Name </li>
                <li className="text-lg leading-7 mb-4 flex items-start gap-2"> <FaCheckCircle className="mt-1 min-h-5 min-w-5 text-vasaskills-green" />Phone Number</li>
                <li className="text-lg leading-7 mb-4 flex items-start gap-2"> <FaCheckCircle className="mt-1 min-h-5 min-w-5 text-vasaskills-green" />Email Address</li> 
                </ol>
                ...
                <p className="text-lg leading-7 mb-4"><strong className="bg-vasaskills-red text-white px-2 py-1 rounded ">STEP #6</strong> : After receiving your credentials, we will complete the form and send you a preview copy before final submission,</p>
                <p className="text-lg leading-7 mb-4"><strong className="bg-vasaskills-red text-white px-2 py-1 rounded ">STEP #7</strong> : Finally, after previewing and making corrections where necessary, we will submit the form and send you the final copy which you can print anywhere if you wish.</p>
                <p className="text-lg leading-7 mb-4">However, if you feel you can do it yourself, then follow these steps to apply for a postgraduate program at UNILAG:</p>
                <ol>
                    <li className="text-lg leading-7 mb-4 flex items-start gap-2"><TbCircleNumber1Filled className="min-h-8	min-w-8 text-lg text-vasaskills-green" /><span><strong>Visit the UNILAG PG Portal:</strong> Go to the <a href="https://spgs.unilag.edu.ng" target="_blank">UNILAG School of Postgraduate Studies website</a>.</span></li>
                    <li className="text-lg leading-7 mb-4 flex items-start gap-2"><TbCircleNumber2Filled className="min-h-8	min-w-8 text-lg text-vasaskills-green" /><span><strong>Create an Account:</strong> Click on the &apos;Apply Now&apos; button and create a new account.</span></li>
                    <li className="text-lg leading-7 mb-4 flex items-start gap-2"><TbCircleNumber3Filled className="min-h-8	min-w-8 text-lg text-vasaskills-green" /><span><strong>Fill Out the Application Form:</strong> Complete the form with accurate personal and academic information.</span></li>
                    <li className="text-lg leading-7 mb-4 flex items-start gap-2"><TbCircleNumber4Filled className="min-h-8	min-w-8 text-lg text-vasaskills-green" /><span><strong>Upload Required Documents:</strong> Upload your academic transcripts, NYSC discharge certificate, and other necessary documents.</span></li>
                    <li className="text-lg leading-7 mb-4 flex items-start gap-2"><TbCircleNumber5Filled className="min-h-8	min-w-8 text-lg text-vasaskills-green" /><span><strong>Pay the Application Fee:</strong> The application fee is ₦22,500. Payment can be made online via the portal.</span></li>
                    <li className="text-lg leading-7 mb-4 flex items-start gap-2"><TbCircleNumber6Filled className="min-h-8	min-w-8 text-lg text-vasaskills-green" /><span><strong>Submit the Application:</strong> Review your application and submit it before the deadline.</span></li>
                    <li className="text-lg leading-7 mb-4 flex items-start gap-2"><TbCircleNumber7Filled className="min-h-8	min-w-8 text-lg text-vasaskills-green" /><span><strong>Print Confirmation:</strong> Print the application confirmation page for your records.</span></li>
                </ol>
                <h2 className="text-2xl font-bold mt-8 mb-4" id="available-courses">Available Courses</h2>
                <p className="text-lg leading-7 mb-4"><Link href="/unilag/postgraduate/courses" className="text-vasaskills-blue hover:underline">Here is a Full List of UNILAG Postgraduate Courses and Requirements</Link>.</p>
                ...
                <h2 className="text-2xl font-bold mt-8 mb-4" id = "school-fees">School Fees</h2>
                ...
                <p className="text-lg leading-7 mb-4">You can see more detail about the <Link href="/unilag/postgraduate/school-fees" className="text-vasaskills-blue hover:underline">UNILAG Postgraduate School Fees for Each Course</Link>.</p>
                <h2 className="text-2xl font-bold mt-8 mb-4" id = "entrance-exam">Entrance Exam</h2>
                ...
                <h2 className="text-2xl font-bold mt-8 mb-4" id = "past-questions">Past Questions</h2>
                ...
                <ul>
                    ...
                    <li className="text-lg leading-7 mb-4 flex items-start gap-2"><FaCheckCircle className="mt-1 min-h-5 min-w-5 text-vasaskills-green" /><span><strong>Prepare for the Entrance Exam:</strong> Study diligently for the entrance exam, focusing on your chosen field. Consider using resources from the <a href="https://www.naeap.org.ng" target="_blank">National Association for Educational Administration and Planning (NAEAP)</a>.</span></li>
                    <li className="text-lg leading-7 mb-4 flex items-start gap-2"><FaCheckCircle className="mt-1 min-h-5 min-w-5 text-vasaskills-green" /><span><strong>Keep Documents Handy:</strong> Ensure all required documents are ready and correctly scanned.</span></li>
                    <li className="text-lg leading-7 mb-4 flex items-start gap-2"><FaCheckCircle className="mt-1 min-h-5 min-w-5 text-vasaskills-green" /><span><strong>Follow Instructions:</strong> Adhere to all guidelines provided on the application portal.</span></li>
                </ul>
                <h2 className="text-2xl font-bold mt-8 mb-4" id = "tips">Frequently Asked Questions</h2>
                <h3 className="text-xl font-bold mt-8 mb-4">1. Can I apply for multiple postgraduate programs at UNILAG?</h3>
                <p className="text-lg leading-7 mb-4">Yes, you can apply for more than one program, but you must pay the application fee for each program separately.</p>
                <h3 className="text-xl font-bold mt-8 mb-4">2. Is there an age limit for applying to UNILAG postgraduate programs?</h3>
                <p className="text-lg leading-7 mb-4">No, there is no age limit for postgraduate applications at UNILAG.</p>
                <h3 className="text-xl font-bold mt-8 mb-4">3. How can I check the status of my application?</h3>
                <p className="text-lg leading-7 mb-4">You can check your application status by logging into your account on the postgraduate application portal.</p>
                <h3 className="text-xl font-bold mt-8 mb-4">4. What should I do if I encounter issues during the application process?</h3>
                <p className="text-lg leading-7 mb-4">If you face any problems, contact the UNILAG School of Postgraduate Studies via their official contact channels.</p>
                <h2 className="text-xl font-bold mt-8 mb-4">Conclusion</h2>
                <p className="text-lg leading-7 mb-4">Applying for a postgraduate program at the University of Lagos is a step towards advancing your academic and professional career. By following the guidelines provided in this post, you can navigate the application process smoothly and increase your chances of being admitted. Stay updated with important dates and ensure all your documents are in order before submitting your application. Best of luck!</p>
                <p className="text-lg leading-7 mb-4">By following the steps and tips outlined in this guide, you can make your application for the UNILAG postgraduate form a successful one. For more information, visit the <a href="https://spgs.unilag.edu.ng" target="_blank">UNILAG School of Postgraduate Studies website</a>.</p>
                <p className="text-lg leading-7 mb-4">Feel free to leave a comment if you have any questions or need further assistance with your application!</p>
            </div>
        </div>
    )
}